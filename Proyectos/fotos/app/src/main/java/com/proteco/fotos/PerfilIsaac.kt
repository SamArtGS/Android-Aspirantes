...
import kotlinx.android.synthetic.main.activity_perfil_isaac.*

class PerfilIsaac : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_perfil_isaac)
        ...
        */
        volverIsaac.setOnClickListener {
            finish()
        }
    }
}